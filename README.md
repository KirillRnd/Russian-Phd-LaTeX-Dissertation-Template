...
Рабочая ветка содержит каноническую LaTeX/BibLaTeX-версию диссертации.
Однократный перенос из DOCX завершён, а импортёры удалены. Исторические отчёты
переноса описаны в [migration/README.md](migration/README.md).
